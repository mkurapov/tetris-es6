	...
	var Tetris = function () {
	  ...
	  _createClass(Tetris, [{
	    ...
	    value: function run() {
	      ...
	      this.currentTet = new _Tetrominos.TetrominoI();
	
	      this.insertTetromino();
	
	      // this.gameBoard[14] = ['E', 'E', 'E', 'E', 'E', 'P', 'E', 'E', 'E','E']
	      // this.gameBoard[15] = ['E', 'E', 'R', 'R', 'P', 'P', 'E', 'E', 'E','E']
	      // this.gameBoard[16] = ['E', 'Y', 'Y', 'R', 'R', 'P', 'E', 'E', 'E','E']
	      // this.gameBoard[17] = ['O', 'Y', 'Y', 'G', 'B', 'B', 'R', 'R', 'E','E']
	      // this.gameBoard[18] = ['O', 'O', 'O', 'G', 'G', 'B', 'O', 'R', 'R','E']
	      // this.gameBoard[19] = ['C', 'C', 'C', 'C', 'G', 'B', 'O', 'O', 'O','E']
	      this.renderGameBoard();
