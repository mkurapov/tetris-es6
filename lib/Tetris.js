	...
	var Tetris = function () {
	  ...
	  _createClass(Tetris, [{
	    ...
	    value: function spawnTetromino() {
	      ...
	      var tetrominos = [new _Tetrominos.TetrominoI(), new _Tetrominos.TetrominoJ(), new _Tetrominos.TetrominoL(), new _Tetrominos.TetrominoS(), new _Tetrominos.TetrominoZ(), new _Tetrominos.TetrominoO()];
